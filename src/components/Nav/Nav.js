...
const Nav = ({signInState, onSignOut, onRegister, isRegister, onSetLanguage}) => {
    ...
    if(signInState===true){
        return(
            <nav className="flex justify-end">
                <div className="f5 code mh3 mh4-ns mv3 pointer bb b--silver bw1" onClick={onSignOut}>
    ...
    //在註冊頁面，只需顯示sign in的選項
        ...
        return(
            <nav className="flex justify-end">
                <div className="f5 code mh2 mh4-ns mv3 pointer bb b--silver bw1" onClick={onSignOut}>
                {/* code font, max horizontal, max vertical,動畫長大 */}
    ...
    //在sign in頁面，顯示sign in和sign out
        ...
        return(
            <nav className="flex justify-end">
                ...
                <div className="f5 code mh2 mh4-ns mv3 pointer bb b--silver bw1" onClick={onRegister}>
                {/* code font, max horizontal, max vertical,動畫長大 */}
